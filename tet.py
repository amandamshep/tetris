...
c7 = (255,105,180) #hot pink
shape_colors = [c1, c2, c3, c4, c5, c6, c7]
...
def convert_shape_format(shape):
    ...
    for i, pos in enumerate(positions):
        #corrects for empty space in shape format
        ...
        if background_color not in row:
            ...
            for j in range(len(row)):
                try:
                   ...
                   continue 
    #full rows deleted, now need to shift every row
    if inc > 0:
        #sort by y val
